...
date_str = (
    f"{weekday} {day} {current_month}, неделя {week_num}"
)
...
investment_rules = (
    "📋 ИНВЕСТИЦИОННЫЕ ПРАВИЛА:\n"
    "1️⃣ No Margin\n"
    "2️⃣ Используй только некоррелируемые позиции:\n"
    "USDT, BTC, ETH, ASTER, LINK, AAVE\n"
...
wisdom = (
    "💡 Иногда лучше выключить мозг и просто HODL.\n\n"
    "Самые богатые биткоин-инвесторы — это те, кто:\n"
    "• впал в кому\n"
    "• потерял приватные ключи\n"
    "• или просто забыл пароль от Ledger в 2017-м\n\n"
    "«We have a 2030 BTC target: base case ~$650,000, "
    "bull case $1–1.5 million.»\n"
    "— Cathie Wood, November 2025"
)
